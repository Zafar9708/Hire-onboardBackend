...
//------------this is correct for interview Schedule
...
//             const emailPromises = [
//                 // Email to candidate (no feedback link)
//                 sendInterviewEmail(
//                     candidate.email,
//                     template.subject,
//                     emailBody.replace(/{feedbackLink}/g, 'N/A'),
//                     meetingLink
//                 ),
//                 // Emails to interviewers (with feedback links)
//                 ...interviewers.map(interviewer => {
...
//                         interviewer.email,
//                         template.subject,
//                         emailBody.replace(/{feedbackLink}/g, feedbackLink),
//                         meetingLink
//                     );
//                 })
//             ];
...
//--------------this is for interview link and feedback form link 
